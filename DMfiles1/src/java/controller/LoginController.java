...
public class LoginController {
    ...
    private StudentAccount stuLogin;
    ...
    public StudentAccount getStuLogin() {
        return stuLogin;
    }

    public void setStuLogin(StudentAccount stuLogin) {
    ...
    public String updateStudentAcc() {
        ...
        int rowCount = aProfileDAO.updateStudentAcc(stuLogin); // Doing anything with the object after this?
        if (rowCount == 1) {
    ...
    public String updateStudentHP() {
        ...
        int rowCount = aProfileDAO.updateStudentHP(stuLogin); // Doing anything with the object after this?
        if (rowCount == 1) {
    ...
    public String updateUnivHP() {
        ...
        int rowCount = aProfileDAO.updateUnivHP(univLogin); // Doing anything with the object after this?
        if (rowCount == 1) {
